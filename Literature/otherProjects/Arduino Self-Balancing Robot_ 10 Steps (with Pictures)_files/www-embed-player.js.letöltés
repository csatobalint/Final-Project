...
;function Nd(a,b,c){var d="script";d=void 0===d?"":d;var e=a.createElement("link");Db(e,b,"preload");d&&(e.as=d);c&&(e.nonce=c);if(a=a.getElementsByTagName("head")[0])try{a.appendChild(e)}catch(f){}}
;var Od=/^\.google\.(com?\.)?[a-z]{2,3}$/,Pd=/\.(cn|com\.bi|do|sl|ba|by|ma)$/;function Qd(a){return Od.test(a)&&!Pd.test(a)}
...
ja:function(){if(!N.da()){var a=p.document,b=function(b){b=Sd(b);a:{try{var c=Rb();break a}catch(h){}c=void 0}var d=c;Nd(a,b,d);c=a.createElement("script");c.type="text/javascript";d&&(c.nonce=d);c.onerror=function(){return p.processGoogleToken({},2)};
...
;function vf(a){this.o=a;this.b=null;this.i=0;this.l=null;this.j=0;this.f=[];for(a=0;4>a;a++)this.f.push(0);this.g=0;this.D=V(window,"mousemove",x(this.G,this));a=x(this.w,this);ra(a)&&(a=ae(a));this.H=window.setInterval(a,25)}
...
function xf(a){if(null==v("_lact",window)){var b=parseInt(Q("LACT"),10);b=isFinite(b)?z()-Math.max(b,0):-1;t("_lact",b,window);t("_fact",b,window);-1==b&&W();V(document,"keydown",W);V(document,"keyup",W);V(document,"mousedown",W);V(document,"mouseup",W);S("lact_local_listeners")||a?(V(window,"resize",function(){yf("resize",200)}),V(window,"scroll",function(){yf("scroll",200)}),new vf(function(){yf("mouse",100)}),V(document,"touchstart",W),V(document,"touchend",W)):(ke("page-mouse",W),ke("page-scroll",W),
ke("page-resize",W))}}
...
;var Af=Math.pow(2,16)-1,Bf={log_event:"events",log_interaction:"interactions"},Cf=Object.create(null);Cf.log_event="GENERIC_EVENT_LOGGING";Cf.log_interaction="INTERACTION_LOGGING";var Df={},Ef=0,X=v("ytLoggingTransportLogPayloadsQueue_")||{};t("ytLoggingTransportLogPayloadsQueue_",X,void 0);var Ff=v("ytLoggingTransportTokensToCttTargetIds_")||{};t("ytLoggingTransportTokensToCttTargetIds_",Ff,void 0);var Gf=v("ytLoggingTransportDispatchedStats_")||{};t("ytLoggingTransportDispatchedStats_",Gf,void 0);
...
function Jf(){fe(Ef);if(!Za(X)){for(var a in X){var b=Df[a];if(b){var c=void 0,d=a,e=b,f=Bf[d],g=Gf[d]||{};Gf[d]=g;b=Math.round(O());for(c in X[d]){var h=e.b;h={client:{hl:h.Ha,gl:h.Ga,clientName:h.Fa,clientVersion:h.innertubeContextClientVersion}};var k=window.devicePixelRatio;k&&1!=k&&(h.client.screenDensityFloat=String(k));Q("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h={context:h};h[f]=If(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=
h[f].length;if(k=Ff[c])a:{var m=h,u=c;if(k.videoId)var M="VIDEO";else if(k.playlistId)M="PLAYLIST";else break a;m.credentialTransferTokenTargetId=k;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:u,scope:M}]}delete Ff[c];k=h;k.requestTimeMs=b;(M=Q("EVENT_ID",void 0))&&S("enable_gel_web_client_event_id")&&(m=(Q("BATCH_CLIENT_COUNTER",void 0)||0)+1,m>Af&&(m=1),P("BATCH_CLIENT_COUNTER",m),k.serializedClientEventId={serializedEventId:M,clientCounter:m});
Lf(e,d,h,{retry:!0})}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete X[a]}}Za(X)||Kf()}}
function Kf(){fe(Ef);Ef=T(Jf,Q("LOGGING_BATCH_TIMEOUT",1E4))}
...
function Pf(a){var b={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")},c;a?c="Bearer "+v("gapi.auth.getToken")().cb:c=ac([]);c&&(b.Authorization=c,b["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));return b}
...
;function Rf(a,b,c,d){$b.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function Sf(){var a=new xd;(a=a.isAvailable()?new Ed(a,"yt.innertube"):null)||(a=new zd("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new sd(a):null;this.f=document.domain||window.location.hostname}
Sf.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,z()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Jc(b))}catch(f){return}else e=escape(b);Rf(a,e,c,this.f)};
Sf.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=$b.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Sf.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;$b.remove(""+a,"/",void 0===b?"youtube.com":b)};var Tf=new Sf;function Uf(a,b,c,d){if(d)return null;d=Tf.get("nextId",!0)||1;var e=Tf.get("requests",!0)||{};e[d]={method:a,request:b,authState:Qf(c),requestTime:Math.round(O())};Tf.set("nextId",d+1,86400,!0);Tf.set("requests",e,86400,!0);return d}
...
c.oa=function(a,b){Vf(m);M(a,b)}}try{S("use_fetch_for_op_xhr")?Le(h,e):Ue(h,e)}catch(aa){if("InvalidAccessError"==aa)m&&(Vf(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
else throw aa;}m&&ef(function(){Wf(a)},5E3)}
;var Xf=z().toString();
...
function eg(a,b){P("client-screen-nonce",a);P("ROOT_VE_TYPE",b);window.requestAnimationFrame(function(){setTimeout(function(){a&&Mf("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Zf,clientScreenNonce:a})},0)})}
;function fg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=Id(J(window.location.href)[3]||null);f&&e.push(f);f=Id(J(d)[3]||null);if(0<=ya(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Cb(e,d),d=e.href),d){f=J(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
dg();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Pa(d).toString(36),b=b?Kd(b):"",Rf(d,b,h||5))}else h="ST-"+Pa(d).toString(36),b=b?Kd(b):"",Rf(h,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var u=void 0===u?window:u;c=u.location;a=Ld(a,k)+m;a=a instanceof E?a:xb(a);c.href=vb(a)}return!0}
...
;function ig(a){a=a||{};this.url=a.url||"";this.args=a.args||ab(jg);this.assets=a.assets||{};this.attrs=a.attrs||ab(kg);this.params=a.params||ab(lg);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var jg={enablejsapi:1},kg={},lg={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};function mg(a){var b=new ig,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==pa(d)?ab(d):d}return b}
;function ng(){G.call(this);this.b=[]}
n(ng,G);ng.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.fb)}G.prototype.m.call(this)};var og=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function pg(a){a=a||"";if(window.spf){var b=a.match(og);spf.style.load(a,b?b[1]:"",void 0)}else qg(a)}
function qg(a){var b=rg(a),c=document.getElementById(b),d=c&&de(c,"loaded");d||c&&!d||(c=sg(a,b,function(){de(c,"loaded")||(be(c),ne(b),T(y(oe,b),0))}))}
...
function rg(a){var b=document.createElement("A");a=yb(a);Cb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Pa(b)}
;var tg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",tg,void 0);var ug=0;function vg(a){tg[a]=tg[a]||{count:0};var b=tg[a];b.count++;b.time=O();ug||(ug=ef(wg,5E3));return 10<b.count?(11==b.count&&af(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function wg(){var a=O(),b;for(b in tg)6E4<a-tg[b].time&&delete tg[b];ug=0}
;function xg(a,b){this.version=a;this.args=b}
;function yg(a){this.topic=a}
yg.prototype.toString=function(){return this.topic};var zg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.L;I.prototype.publish=I.prototype.J;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",zg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Ag(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var Y=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Bg(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Cg(){var a=Bg(),b;for(b in a)jf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function Dg(a,b){xg.call(this,1,arguments)}
n(Dg,xg);function Eg(a,b){xg.call(this,1,arguments)}
n(Eg,xg);var Fg=new yg("aft-recorded"),Gg=new yg("timing-sent");var Hg={vc:!0},Ig={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},Jg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),Mg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
Ng=!1;
function Og(a){if("_"!=a[0]){var b=a;Y.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),Y.mark(b))}b=Pg();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Bg();if(c=b[a])jf(c),b[a]=0;Qg()["tick_"+a]=void 0;O();Rg()?(b=Sg(),"_start"==a?vg("baseline_"+b)||Mf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):vg("tick_"+a+"_"+b)||Mf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=Zd("TIMING_ACTION"),a=
Pg(),v("ytglobal.timingready_")&&b&&a._start&&(b=Tg()))){S("tighter_critical_section")&&!Ng&&(Ag(Fg,new Dg(Math.round(b-a._start),void 0)),Ng=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Ug()}}
function Vg(){var a=Wg().info.yt_lt="hot_bg";Qg().info_yt_lt=a;if(Rg())if("yt_lt"in Ig){var b=Ig.yt_lt;0<=ya(Mg,b)&&(a=!!a);if(Rg()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=Sg();b=Object.keys(c).join("");vg("info_"+b+"_"+a)||(c.clientActionNonce=a,Mf("latencyActionInfo",c,void 0,void 0))}}else 0<=ya(Jg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
function Tg(){var a=Pg();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Ug(){Cg();if(!Rg()){var a=Pg(),b=Wg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in Hg){var f=Aa(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Xg(f,e),Yg(),Zg(),$g(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=Y.getEntriesByName?Y.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=Tg();ah()&&"youtube"==g&&(Vg(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=O();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Xg(f,e,void 0);Ag(Gg,new Eg(b.aft+(h||0),void 0))}}}
var Zg=x(Y.clearResourceTimings||Y.webkitClearResourceTimings||Y.mozClearResourceTimings||Y.msClearResourceTimings||Y.oClearResourceTimings||na,Y);
function Xg(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Xe(a,void 0,void 0,void 0,f)}catch(g){Xe(a,void 0,void 0,void 0,f)}}else Xe(a);$g(!0,c)}
function Sg(){var a=Wg().nonce;a||(a=Yf(),Wg().nonce=a);return a}
function Pg(){return Wg().tick}
function Qg(){var a=Wg();"gel"in a||(a.gel={});return a.gel}
function Wg(){return v("ytcsi.data_")||Yg()}
function Yg(){var a={tick:{},info:{}};t("ytcsi.data_",a,void 0);return a}
function $g(a,b){t("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function ah(){var a=Pg(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Wg().info.yt_pvis}
function Rg(){return!!S("csi_on_gel")}
;function bh(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;uc(this,y(vc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};ch(this);this.V("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new ng(this);uc(this,y(vc,this.va))}
n(bh,G);l=bh.prototype;
l.ha=function(a){if(!this.h){a instanceof ig||(a=new ig(a));this.Y=a;this.b=mg(a);this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.H,this.b.attrs.id=this.H);this.l.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.H;this.S||(this.S=dh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=Tb(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=Tb(Number(a)||
a);eh(this);this.o&&fh(this)}};
...
function gh(a){var b=!0,c=hh(a);c&&a.b&&(a=a.b,b=de(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function eh(a){if(!a.h&&!a.N){var b=gh(a);if(b&&"html5"==(hh(a)?"html5":null))a.O="html5",a.o||ih(a);else if(jh(a),a.O="html5",b&&a.j)a.T.appendChild(a.j),ih(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=mg(a.b);v("yt.player.Application.create")(a.T,b);ih(a)};
a.N=!0;b?a.D():(se(a.b.assets.js,a.D),pg(a.b.assets.css),kh(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function hh(a){var b=Hb(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
function ih(a){if(!a.h){var b=hh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||lh(a)):a.ka=T(function(){ih(a)},50)}}
function lh(a){ch(a);a.o=!0;var b=hh(a);b.addEventListener&&(a.G=mh(a,b,"addEventListener"));b.removeEventListener&&(a.R=mh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=mh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);fh(a);a.S&&a.S(a.f);a.w.J("onReady",a.f)}
function mh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function ch(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)fe(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Sa.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.Ka.bind(a)}
l.Ka=function(){return this.o};
l.V=function(a,b){var c=this,d=dh(this,b);if(d){if(!(0<=ya(this.ua,a)||this.i[a])){var e=nh(this,a);this.G&&this.G(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
l.Sa=function(a,b){if(!this.h){var c=dh(this,b);c&&md(this.w,a,c)}};
function dh(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.U[b]=c}return c?c:null}
function nh(a,b){var c="ytPlayer"+b+a.H;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=T(function(){if(!a.h){a.w.J(b,c);var d=a.P,e=String(f);e in d&&delete d[e]}},0);
$a(a.P,String(f))}};
return c}
...
l.Da=function(){return this.O||(hh(this)?"html5":null)};
l.Ca=function(){return this.X};
function jh(a){Og("dcp");a.cancel();ch(a);a.O=null;a.b&&(a.b.loaded=!1);var b=hh(a);b&&(gh(a)||!kh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.D&&ye(this.b.assets.js,this.D);fe(this.ka);this.N=!1};
l.m=function(){jh(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(Error("Error destroying player: "+b))}this.U=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.T;delete this.l;G.prototype.m.call(this)};
function kh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var oh={},ph="player_uid_"+(1E9*Math.random()>>>0);function qh(a){var b="player";b=r(b)?Hb(b):b;var c=ph+"_"+(b[ta]||(b[ta]=++ua)),d=oh[c];if(d)return d.ha(a),d.f;d=new bh(b,c);oh[c]=d;ne("player-added",d.f);uc(d,y(rh,d));T(function(){d.ha(a)},0);
return d.f}
function rh(a){delete oh[a.H]}
;function sh(){var a=th(),b=uh();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!r(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!r(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var uh=Nb(function(){var a=new xd;return a.isAvailable()?new td(a):null}),th=Nb(function(){var a=new yd;
return a.isAvailable()?new td(a):null});function vh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function wh(a,b,c){r(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return xh(a)}
function xh(a,b,c){if(sa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function yh(a,b,c,d){if(sa(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function zh(a){var b=a.video_id||a.videoId;if(r(b)){var c=sh()||{},d=sh()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=uh();if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function Ah(a){G.call(this);this.b=a;this.b.subscribe("command",this.ra,this);this.f={};this.i=!1}
A(Ah,G);l=Ah.prototype;l.start=function(){this.i||this.h||(this.i=!0,Bh(this.b,"RECEIVING"))};
l.ra=function(a,b,c){if(this.i&&!this.h){var d=b||{};switch(a){case "addEventListener":r(d.event)&&(a=d.event,a in this.f||(c=x(this.Ua,this,a),this.f[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":r(d.event)&&Ch(this,d.event);break;default:this.g.isReady()&&this.g[a]&&(b=Dh(a,b||{}),c=this.g.handleExternalCall(a,b,c||null),(c=Eh(a,c))&&this.i&&!this.h&&Bh(this.b,a,c))}}};
l.Ua=function(a,b){this.i&&!this.h&&Bh(this.b,a,this.ba(a,b))};
l.ba=function(a,b){if(null!=b)return{value:b}};
function Ch(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
l.m=function(){var a=this.b;a.h||md(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)Ch(this,b);Ah.u.m.call(this)};function Fh(a,b){Ah.call(this,b);this.g=a;this.start()}
A(Fh,Ah);Fh.prototype.addEventListener=function(a,b){this.g.addEventListener(a,b)};
Fh.prototype.removeEventListener=function(a,b){this.g.removeEventListener(a,b)};
function Dh(a,b){switch(a){case "loadVideoById":return b=xh(b),zh(b),[b];case "cueVideoById":return b=xh(b),zh(b),[b];case "loadVideoByPlayerVars":return zh(b),[b];case "cueVideoByPlayerVars":return zh(b),[b];case "loadPlaylist":return b=yh(b),zh(b),[b];case "cuePlaylist":return b=yh(b),zh(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
case "setLoop":return[b.loopPlaylists];case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey]}return[]}
function Eh(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
Fh.prototype.ba=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Fh.u.ba.call(this,a,b)};
Fh.prototype.m=function(){Fh.u.m.call(this);delete this.g};function Gh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.g=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
n(Gh,G);Gh.prototype.w=function(a){if(!("*"!=this.g&&a.origin!=this.g||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.D&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.g=this.o=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=ya(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
Gh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Jc(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
Gh.prototype.m=function(){window.removeEventListener("message",this.l);G.prototype.m.call(this)};function Hh(a,b,c){Gh.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Hh,Gh);function Ih(){var a=this.f=new Hh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Oa,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
l=Ih.prototype;l.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Jh(this,a)),this.i[a]=!0)):this.ta(a,b,c)};
l.ta=function(){};
function Jh(a,b){return x(function(a){this.sendMessage(b,a)},a)}
...
function Kh(a,b){a.sendMessage("infoDelivery",b)}
l.sa=function(a){this.j?this.f.sendMessage(a):this.g.push(a)};
l.sendMessage=function(a,b){this.sa({event:a,info:void 0==b?null:b})};
l.dispose=function(){this.f=null};function Lh(a){Ih.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Na,this));this.addEventListener("onVideoProgress",x(this.Ya,this));this.addEventListener("onVolumeChange",x(this.Za,this));this.addEventListener("onApiChange",x(this.Ta,this));this.addEventListener("onPlaybackQualityChange",x(this.Va,this));this.addEventListener("onPlaybackRateChange",x(this.Wa,this));this.addEventListener("onStateChange",x(this.Xa,this));this.addEventListener("onWebglSettingsChanged",x(this.ab,
this))}
A(Lh,Ih);l=Lh.prototype;l.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&vh(a)){var d=b;if(sa(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=xh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=wh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=yh.apply(window,d)}d=e}zh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);vh(a)&&Kh(this,this.ca())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());Kh(this,a)};
l.Va=function(a){Kh(this,{playbackQuality:a})};
l.Wa=function(a){Kh(this,{playbackRate:a})};
...
l.Za=function(){Kh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Kh(this,a)};
l.ab=function(){if(this.b.getSphericalProperties){var a={SphericalProperties:this.b.getSphericalProperties()};Kh(this,a)}};
l.dispose=function(){Lh.u.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.b.removeEventListener(b.eventType,b.listener)}this.h=[]};function Mh(){G.call(this);this.b=new I;uc(this,y(vc,this.b))}
A(Mh,G);Mh.prototype.subscribe=function(a,b,c){return this.h?0:this.b.subscribe(a,b,c)};
Mh.prototype.j=function(a,b){this.h||this.b.J.apply(this.b,arguments)};function Nh(a,b,c){Mh.call(this);this.f=a;this.g=b;this.i=c}
A(Nh,Mh);function Bh(a,b,c){if(!a.h){var d=a.f;d.h||a.g!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Jc(a),d.g))}}
Nh.prototype.m=function(){this.g=this.f=null;Nh.u.m.call(this)};function Oh(a,b,c){G.call(this);this.b=a;this.g=c;this.i=V(window,"message",x(this.j,this));this.f=new Nh(this,a,b);uc(this,y(vc,this.f))}
A(Oh,G);Oh.prototype.j=function(a){var b;if(b=!this.h)if(b=a.origin==this.g)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,r(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.f,c.h||c.j("command",b.command,b.data,a.origin))}};
Oh.prototype.m=function(){uf(this.i);this.b=null;Oh.u.m.call(this)};function Ph(){var a=Wa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||Q("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||S("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=ab(Qh),c;return cd(new H(function(d,e){b.A=function(a){Ge(a)?d(a):e(new Rh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){e(new Rh("Unknown request error","net.unknown",a))};
b.M=function(a){e(new Rh("Request timed out","net.timeout",a))};
...
n(Rh,B);function Sh(a){this.h=void 0===a?null:a;this.f=0;this.b=null}
Sh.prototype.then=function(a,b,c){return this.h?this.h.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Qc(a)?a:Th(a)):2===this.f&&b?(a=b.call(c,this.b),Qc(a)?a:Uh(a)):this};
Sh.prototype.getValue=function(){return this.b};
Pc(Sh);function Uh(a){var b=new Sh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Th(a){var b=new Sh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function Vh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Wh;this.isTimeout=a instanceof Rh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof dd}
n(Vh,B);Vh.prototype.name="BiscottiError";function Wh(){B.call(this,"Biscotti ID is missing from server")}
n(Wh,B);Wh.prototype.name="BiscottiMissingError";var Qh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Xh=null;function Yh(){if("1"===Wa($d(),"args","privembed"))return Vc(Error("Biscotti ID is not available in private embed mode"));Xh||(Xh=cd(Ph().then(Zh),function(a){return $h(2,a)}));
return Xh}
function Zh(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Wh;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Wh;a=a.id;ai(a);Xh=Th(a);bi(18E5,2);return a}
function $h(a,b){var c=new Vh(b);ai("");Xh=Uh(c);0<a&&bi(12E4,a-1);throw c;}
function bi(a,b){T(function(){cd(Ph().then(Zh,function(a){return $h(b,a)}),na)},a)}
function ai(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function ci(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Yh()}catch(b){return Vc(b)}}
;function di(a){B.apply(this,arguments)}
n(di,B);di.prototype.name="YuzuError";function ei(){var a=new di("ID is missing"),b=new di("Timeout"),c=null,d=!1;Wd(function(){c=Ud();d=!0});
if(d)return c?Th(c):Uh(a);var e=new H(function(b,c){Wd(function(){var d=Ud();d?b(d):c(a)})}),f=Gd().then(function(){return Vc(b)});
return ad(Yc([e,f]),function(){return f.cancel()})}
;function fi(a){if("1"!==Wa($d(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||xa("yt.ads.biscotti.getId_",Yh));try{var b=ci();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",ei,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Vc(d)}}else c=Vc(new di("unimplemented"));Zc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Ub;c.flash="0";a:{try{var d=window.top.location.href}catch(Ua){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type="image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Ua){}try{var M=k.outerWidth;var aa=k.outerHeight}catch(Ua){}try{var Kg=k.innerWidth;var Lg=k.innerHeight}catch(Ua){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,M,aa,Kg,Lg];u=window.top;try{var U=(u||window).document,Ta="CSS1Compat"==U.compatMode?U.documentElement:
U.body;var Ga=(new Gb(Ta.clientWidth,Ta.clientHeight)).round()}catch(Ua){Ga=new Gb(-12245933,-12245933)}U={};Ta=0;p.SVGElement&&p.document.createElementNS&&(Ta|=1);U.bc=Ta;U.bih=Ga.height;U.biw=Ga.width;U.brdim=m.join();Ga=(U.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Sb.visibilityState||Sb.webkitVisibilityState||Sb.mozVisibilityState||""]||0,U.wgl=!!F.WebGLRenderingContext,U);for(var Md in Ga)d[Md]=Ga[Md]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=gi++;Ue("//www.youtube.com/ad_data_204",
{Ea:!1,B:d,withCredentials:!0})}});
T(fi,18E5)}catch(d){R(d)}}}
var gi=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function hi(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=$b.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
l=hi.prototype;l.get=function(a,b){ii(a);ji(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
l.set=function(a,b){ii(a);ji(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
l.remove=function(a){ii(a);ji(a);delete Z[a]};
l.save=function(){var a=this.b,b=[],c;for(c in Z)b.push(c+"="+encodeURIComponent(String(Z[c])));Rf(a,b.join("&"),63072E3)};
...
oa(hi);var li=null,mi=null,ni=null,oi={};function pi(a){Mf(a.payload_name,a.payload,void 0,void 0)}
function qi(a){var b=a.id;a=a.ve_type;var c=bg++;a=new $f(void 0,a,c,void 0,void 0);oi[b]=a;b=dg();c=cg();b&&c&&gg(b,c,a)}
function ri(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(eg(b,a),a=cg()))for(var c in oi){var d=oi[c];d&&gg(b,a,d)}}
function si(a){oi[a.id]=new $f(a.tracking_params)}
function ti(a){var b=dg();a=oi[a.id];b&&a&&(S("interaction_click_on_gel_web")?Mf("visualElementGestured",{csn:b,ve:ag(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):hg({click:{csn:b,visualElement:ag(a)}}))}
function ui(a){a=a.ids;var b=dg();if(b)for(var c=0;c<a.length;c++){var d=oi[a[c]];d&&Mf("visualElementShown",{csn:b,ve:ag(d),eventType:1})}}
...
t("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);fi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&zh(a.args);li=a=qh(a);a.addEventListener("onScreenChanged",ri);a.addEventListener("onLogClientVeCreated",qi);a.addEventListener("onLogServerVeCreated",si);a.addEventListener("onLogToGel",pi);
a.addEventListener("onLogVeClicked",ti);a.addEventListener("onLogVesShown",ui);a.addEventListener("onReady",vi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?ni=new Lh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(mi=new Oh(window.parent,b,c),ni=new Fh(a,mi.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&Ae();mf()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Xe(a+"mac_204?action_fcts=1");return!0},void 0);
var wi=ae(function(){Og("ol");var a=hi.getInstance(),b=!!((ki("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&yc(document.body,"exp-invert-logo"))if(c&&!yc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):yc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&yc(document.body,"inverted-hdpi")&&zc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=ki(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),xi=ae(function(){var a=li;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(ze=null);a=0;for(var b=kf.length;a<b;a++)jf(kf[a]);kf.length=0;xe("//static.doubleclick.net/instream/ad_status.js");lf=!1;P("DCLKSTAT",0);wc(ni,mi);if(a=li)a.removeEventListener("onScreenChanged",ri),a.removeEventListener("onLogClientVeCreated",qi),a.removeEventListener("onLogServerVeCreated",si),a.removeEventListener("onLogToGel",pi),a.removeEventListener("onLogVeClicked",ti),a.removeEventListener("onLogVesShown",ui),a.removeEventListener("onReady",
vi),a.destroy();oi={}});
window.addEventListener?(window.addEventListener("load",wi),window.addEventListener("unload",xi)):window.attachEvent&&(window.attachEvent("onload",wi),window.attachEvent("onunload",xi));xa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||Ce);xa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||De);xa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||nf);xa("yt.player.exports.navigate",v("yt.player.exports.navigate")||fg);
