...
\end{equation}
If $\zeta<1$, then the system is underdamped, the two poles are both complex-valued with negative real parts. The system is asymptotically stable and oscillating with the damped natural frequency $\omega_d = \omega_n \sqrt{1-{\zeta}^2}$.
\begin{figure}[htb!]
	\centering
	\includegraphics[height=5cm]{figures/second_order_underdamped_response}
	\caption{Step response characteristics \cite{mathworks}}
	\label{second_order_underdamped_response}
\end{figure}
\begin{figure}[htb!]
	\centering
	\includegraphics[width=15cm]{figures/temporary_figure_1}
	\caption{Step response characteristics \cite{mathworks}}
	\label{second_order_underdamped_response}
\end{figure}
